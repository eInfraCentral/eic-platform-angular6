...
export class ServiceProviderService {
  ...
  getServicesOfProvider(id: string, noOfServices: number) {
    return this.http.get<Pagination<InfraService>>(this.base + `/service/byProvider/${id}?order=ASC&orderField=name&quantity=${noOfServices}`);
  }
  ...
  getPendingServicesByProvider(id: string, noOfServices: number) {
    return this.http.get<Pagination<InfraService>>(this.base + `/pendingService/byProvider/${id}?order=ASC&orderField=name&quantity=${noOfServices}`);
  }
